...
import { ArrowRight, Brain, Cloud, Shield, Database, Cpu, BarChart3, Code2, Network } from "lucide-react";
          ...
          <div className="space-y-6">
            {services.map((service, i) => (
              <AnimatedSection key={service.title} delay={i * 0.06}>
                <div className="glass-card-hover rounded-xl p-8 group">
        ...
        <div className="container-tight">
          <AnimatedSection>
            <div className="glass-card rounded-2xl p-12 md:p-16 text-center">
              <h2 className="text-3xl md:text-4xl font-display font-bold text-gradient mb-4">Need something specific?</h2>
              <p className="text-muted-foreground max-w-md mx-auto mb-8">We architect custom solutions for challenges that don't fit a standard playbook.</p>
